...
public class RadnikAdapterStat1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RadnikAdapterStat1(List<Radnik> radnici) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position) == VIEW_TYPE_AGGREGATE) {
            ...
            aggregateHolder.textViewImePrezime.setText("Ukupno za sve radnike");
            ...
            String statistika = "Broj rezerviranih termina: " + radnik.getBrojacRezerviranihTermina() + "\n"
                    ...
                    + "Ukupno vrijeme rada: " + radnik.getUkupnoVrijemeRada() + " minuta";
